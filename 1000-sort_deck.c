...
/**
 * insertion_sort_deck_kind - Function that sort a deck of cards from
 * spades to diamonds
...
/**
 * insertion_sort_deck_value - Function that sort a deck of cards sorted from
...
/**
 * sort_deck - Function that sort deck of cards from ace to king and
